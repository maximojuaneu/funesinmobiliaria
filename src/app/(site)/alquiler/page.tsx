...
export const metadata: Metadata = {
  ...
  description: 'Encontrá casas, departamentos y locales en alquiler en Funes, Santa Fe.',
}
...
interface Props {
  searchParams: {
    ...
    surfaceFrom?: string; surfaceTo?: string; temp?: string; view?: string
  }
}

export default async function AlquilerPage({ searchParams }: Props) {
  const params = searchParams
  const isTemp = params.temp === '1'
  const operation = isTemp ? 'Temporary Rent' as const : 'Rent' as const
    ...
    <>
      <div className="page-hero">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 uppercase tracking-widest font-montserrat text-center mb-4">
      ...
      <PropertiesPageContent
        ...
        operationType={isTemp ? 'TempRent' : 'Rent'}
